/*
Problem: 1617 bit_strings
Platform: cses
Contest/Difficulty: introductory_problems
URL: TODO_ADD_URL
Topics: TODO_ADD_TOPICS

https://youtu.be/-OPohCQqi_E?feature=shared
*/
...
// NOTE::Uncomment the following preprocessor directive for debugging only,
// online judges do not have access to this header file, so comment out before
// submitting
// Stolen from: https://github.com/sharkdp/dbg-macro
// a dbg(…) macro that can be used in place of printf or cout
//
// #include <dbg.h>
